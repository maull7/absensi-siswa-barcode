                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-center align-items-center">
                            <h6 class="m-0 font-weight-bold text-primary mr-4">Report Harian Pulang</h6>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a href="ulang.php" class="dropdown-item active" type="button">PULANG</a>
                                    <a href="bulanan.php" class="dropdown-item" type="button">BULANAN</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="proses/report-harian-pulang.php" method="POST">
                                <div class="col-md-12">
